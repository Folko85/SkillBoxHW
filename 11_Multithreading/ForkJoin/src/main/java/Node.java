...
public class Node implements Comparable<Node> {
    ...
    private CopyOnWriteArraySet<Node> subLinks;   // а ешё у него есть множество узлов-потомков

    public Node(String url) {
        this.url = url;
        this.subLinks = new CopyOnWriteArraySet<>();
        this.depth = 0;
        this.parent = null;
    }
    ...
    public synchronized void addSubLinks(Node subLink) {
